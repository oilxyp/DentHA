                    ...
                    <div class="animate__animated p-6" :class="[$store.app.animation]">
                        <div class="panel p-5">
                            @if ($source === 'process_commu')
                                ...
                                <form method="POST"
                                    action="{{ route('performance_manage.store', ['source' => 'process_commu']) }}">
                                    @csrf
                                    <div class="mb-5">
                            ...
                            @elseif ($source === 'process_createinnovation')
                                ...
                                <form method="POST"
                                    action="{{ route('performance_manage.store', ['source' => 'process_createinnovation']) }}">
                                    @csrf
                                    <div class="mb-5">
                                        <label for="name">รายละเอียด</label>
                                        <textarea id="name" name="name" rows="3" placeholder="กรอกรายละเอียด"
                            ...
                            @elseif ($source === 'process_learn')
                                ...
                                <form method="POST"
                                    action="{{ route('performance_manage.store', ['source' => 'process_learn']) }}">
                                    @csrf
                                    <div class="mb-5">
                                        <label for="name">รายละเอียด</label>
                                        <textarea id="name" name="name" rows="3" placeholder="กรอกรายละเอียด"
